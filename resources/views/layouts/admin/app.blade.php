                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown">
                                    <a class="nav-link menu-title {{  request()->is('admin*') ? 'active' : '' }}"
                                        href="javascript:void(0)"><i data-feather="home"></i><span>Beranda</span></a>
                                    <ul class="nav-submenu menu-content" style="display: none;">
                                        <li><a href="{{route('admin.index')}}"
                                                class="{{ request()->routeIs('admin.index') ? 'active' : ''}}">Dashboard</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="nav-link menu-title {{  request()->is('user*') ? 'active' : '' }}"
                                        href="javascript:void(0)"><i data-feather="box"></i><span>Master Data</span></a>
                                    <ul class="nav-submenu menu-content" style="display: none;">
