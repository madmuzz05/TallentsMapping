...
<input type="hidden" name="jumlah_pertanyaan" value="{{$tanyaan}}">
    ...
    <div class="row animate-chk mt-4 mb-4">
        ...
        <div class="col-lg-6 m-l-35 text-left">
            ...
            <label class="d-block" for="0">
                <input class="radio_animated" id="0" type="radio" value="0" {{ ($o->nilai == '0')? 'checked' : ''}}
                    name="ans"> Tidak
                Relevan
            </label>
            ...
            <label class="d-block" for="c">
                <input class="radio_animated" id="c" type="radio" value="3" {{ ($o->nilai == '3')? 'checked' : ''}}
                    name="ans"> Sedang
            </label>
            <label class="d-block" for="d">
                <input class="radio_animated" id="d" type="radio" value="4" {{ ($o->nilai == '4')? 'checked' : ''}}
                    name="ans"> Sesuai
            </label>
            <label class="d-block" for="e">
                <input class="radio_animated" id="e" type="radio" value="5" {{ ($o->nilai == '5')? 'checked' : ''}}
                    name="ans"> Sangat Sesuai
            </label>
            @empty
